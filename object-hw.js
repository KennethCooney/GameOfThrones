...
// gameOfThronesHouses[0].name
// 2.  Get the Lannister houses wikiSuffix 
// gameOfThronesHouses[1].wikiSuffix
// 3.  Get the name Catelyn (Tully) Stark
// gameOfThronesHouses[6].people[0].name
// 4.  Get the fourth houses, second persons description  
// gameOfThronesHouses[3].people[1].description;
// 5.  Get a list of all the houses names
var array = [];
for (var i = 0; i < gameOfThronesHouses.length; i++){
  array.push(gameOfThronesHouses[i].name);
}
console.log(array);
// 6.  Get a list of all the peoples names
var array = [];
for (var i = 0; i < gameOfThronesHouses.length; i++){
  for (var j = 0; j <gameOfThronesHouses[i].people.length; j++ ){
    array.push(gameOfThronesHouses[i].people[j].name);
  }
}
